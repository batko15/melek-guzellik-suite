    ...
    <div className="mk-velvet relative flex min-h-screen items-center justify-center overflow-hidden bg-background px-4 py-10">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          <div className="mk-anim-pulse mk-logo-sheen mx-auto mb-4 flex h-16 w-16 items-center justify-center overflow-hidden rounded-full border border-primary/40 bg-primary/10">
            <img
