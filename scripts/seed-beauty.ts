...
// ─── Galeri ──────────────────────────────────────────────────────────────────
// Gerçek stüdyo fotoğrafları (melek.zip — Instagram gönderileri) + hero görseli
const GALLERY = [
  ...
  { title: "Özel Gün Takımı", category: "tirnak", imagePath: "/gallery/real/ozel-gun-takimi.jpg", sortOrder: 7 },
